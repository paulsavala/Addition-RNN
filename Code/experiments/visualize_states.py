...
if __name__ == '__main__':
    ...
    # model2 = KMMSeq2Seq(name='basic_addition',
    #                    encoder_units=128,
    #                    batch_size=128,
    #                    input_seq_length=input_seq_length(Config.n_terms, Config.n_digits),
    #                    target_seq_length=target_seq_length(Config.n_terms, Config.n_digits),
    ...
    # Evaluate on the test set
    input_test_target, output_test_target = format_targets(y_test)
    test_metrics = model2.model.evaluate(x=[X_test, input_test_target], y=output_test_target, verbose=0)
    pprint_metrics(test_metrics, model2.model.metrics_names)